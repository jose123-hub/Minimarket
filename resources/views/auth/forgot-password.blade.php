...
<div class="left">
  ...
  <div class="left-content">
    <h1>Recover your <span class="accent">access.</span></h1>
    <p>Enter your email address and we'll send you a link to reset your password and get back into your account.</p>
  </div>
...
<div class="right">
  <div class="form-box">
    ...
    <p class="form-subtitle">No worries. Enter your email and we'll send you a reset link right away.</p>
    ...
    <p class="hint">Check your spam folder if you don't receive the email within a few minutes.</p>
