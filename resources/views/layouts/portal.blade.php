...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    @if($role === 'admin')
      ...
      <a href="/admin/suppliers" class="nav-item {{ $active === 'suppliers' ? 'active' : '' }}">
    ...
    @else
      ...
      <a href="/cashier/sales/create" class="nav-item {{ $active === 'sales' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>
        Sales (POS)
      </a>
      <a href="/cashier/inventory" class="nav-item {{ $active === 'inventory' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/></svg>
        Inventory
      </a>
      <a href="/cashier/cash" class="nav-item {{ $active === 'cash' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
        Cash Register
      </a>
      <a href="/cashier/loyalty" class="nav-item {{ $active === 'loyalty' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
        Loyalty
      </a>
      <a href="/cashier/returns" class="nav-item {{ $active === 'returns' ? 'active' : '' }}">
        <svg viewBox="0 0 24 24"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 102.13-9.36L1 10"/></svg>
        Returns
      </a>
