...
<title>Express — Edit Supplier</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .form-group input, .form-group select { width: 100%; padding: 10px 14px; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 14px; color: #333; outline: none; transition: border-color 0.2s; }
